// Adapted from SnesJs (MIT): https://github.com/angelo-wf/SnesJs
// This file keeps the original SPC700 logic structure for correctness.
const Spc = (function() {

  function getByteRep(value) {
    ...
    this.cycle = function() {
      if(this.cyclesLeft === 0) {
        ...
        try {
          ...
          throw new Error("SPC700 opcode 0x" + getByteRep(instr) + " failed: " + e);
        }
      }
      this.cyclesLeft--;
    }
